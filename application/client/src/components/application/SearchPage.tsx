...
const SearchPageComponent = ({
  ...
  useEffect(() => {
    ...
    let isMounted = true;
    void import(
      /* webpackChunkName: "feature-search-sentiment" */ "@web-speed-hackathon-2026/client/src/utils/negaposi_analyzer"
    )
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (errors.searchText != null) {
      setError(errors.searchText);
      return;
    }
