    ...
    switch (state.type) {
      case "idle": {
        (async () => {
          ...
          let translator: { translate(text: string): Promise<string>; [Symbol.dispose](): void } | null =
            null;
          try {
            const { createTranslator } = await import(
              /* webpackChunkName: "feature-translate" */ "@web-speed-hackathon-2026/client/src/utils/create_translator"
            );
